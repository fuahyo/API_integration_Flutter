...
import 'package:untitled/presentation/pages/get_profile_cc/get_profile_screen.dart';
...
final GoRouter saRouter = GoRouter(initialLocation: "/home-screen-bs", routes: [
  GoRoute(
      path: "/backend",
  ...
  GoRoute(
    path: "/get-profile-cc",
    name: Routes.getProfileCC,
    builder: (context, state) {
      BlocProvider.of<GetProfileCcCubit>(context).fetchGetProfileCC();
      return const GetProfileScreenCC();
    },
  ),
  GoRoute(
    path: "/forgot-pass-dd",
